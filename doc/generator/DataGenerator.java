    ...
    public CommandLineRunner loadData(StudentRepository studentRepository, MentorRepository mentorRepository,
        ...
        return args -> {
           ...
           // logger.info("Generating demo data");
            ...
            logger.info("... generating 30 Student entities...");
            ...
            studentRepository.saveAll(studentRepositoryGenerator.create(30, seed));

            logger.info("... generating 10 Mentor entities...");
            ...
            mentorRepository.saveAll(mentorRepositoryGenerator.create(10, seed));

            logger.info("... generating 16 Subject entities...");
            ...
            subjectRepository.saveAll(subjectRepositoryGenerator.create(16, seed));
